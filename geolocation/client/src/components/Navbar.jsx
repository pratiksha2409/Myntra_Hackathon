    ...
    <nav className="bg-[#ffffff] w-full border-b md:border-0 md:static">
      <div className="items-center px-4 w-screen-xl  mx-auto md:flex md:px-8">
        ...
        >
          ...
          <ul className="justify-end items-center gap-10 space-y-8 md:flex md:space-x-6 md:space-y-0">
            {navigation.map((item, idx) => {
              return (
                
                <li key={idx} className="text-[#170035] font-bold  border-2 rounded-xl p-2 hover:text-[#f21fb0] ">
